...
投资列表-P2P-债权转让: toAppBondsTransferList(已删除)
投资列表-定期理财-理财计划: toAppFinancialPlanListFi
投资列表-定期理财-定期项目: toAppRegularProjectListFi
P2P-债权转让项目详情: toAppBondsTransferDetails(已删除)
    ...
    */
    ...
    Jsbridge.prototype = {
        ...
        */
        ...
        //更新app（android调用原生方法，ios直接唤起AppStore） android点击无反应
        ...
        */
        ...
        {
            shareTypeList: [{
                ShareToolType: 分享类型 1-微信分享 2-短信分享 3-微博分享 4-QQ分享 5-朋友圈分享 6-QQ空间分享 7-二维码 8-复制链接 9-一键分享
        ...
        */
        ...
        /*---------------1708016新增方法-----start----5.1.6-----*/
        toAppNewPage: function(params) {
            var _params = {
                'title': params.title,
                'url': params.url
            };

            var method = isIOS() ? ToAppNewPage : 'ToAppNewPage';
            caller(method, _params, null, true);
        },

        /*---------------1708016新增方法-----end----5.1.6-----*/
